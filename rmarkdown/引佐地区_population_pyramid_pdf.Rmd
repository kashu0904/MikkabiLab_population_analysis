...
file_path <- "C:/Users/pirat/Documents/mikkabi_population_analysis/data/processed/inasa_population_combined.xlsx"
output_dir <- "C:/Users/pirat/Documents/mikkabi_population_analysis/figures/pyramid/引佐地区"
...
roman_titles <- c("Inasa (Overall)",
                  "Iinoya", "Idaira", "Okuyama", "Kanasashi", "Karishuku",
                  "Kawana", "Kurobuchi", "Shibukawa", "Shihoujou", "Shiraiwa",
                  "Tazawa", "Tabatake", "Tochikubo", "Tokka", "Nishikurumeki",
                  "Nishikuroda", "Hanadaira", "Higashikurumeki", "Higashikuroda", "Bessho",
                  "Matoba", "Mitake", "Yazawa", "Yokoo", "Jinguujicho")
...
for (current_date in date_strings) {
  ...
  pdf_path <- file.path(output_dir, paste0("inasa_pyramids_", current_date, ".pdf"))
