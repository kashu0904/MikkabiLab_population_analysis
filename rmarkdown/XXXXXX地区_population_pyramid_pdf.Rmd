---
title: "XXXXXX地区 人口ピラミッドレポート（出力仕様準拠）"
output:
...
file_path <- "C:/Users/pirat/Documents/mikkabi_population_analysis/data/processed/XXXXXX_population_combined.xlsx"
output_dir <- "C:/Users/pirat/Documents/mikkabi_population_analysis/figures/pyramid/XXXXXX地区"
...
roman_titles <- c("XXXXXX (Overall)","XXXXXX","XXXXXX","XXXXXX")
...
for (current_date in date_strings) {
  ...
  # PDF出力（あなたの設定に完全準拠）
  pdf_path <- file.path(output_dir, paste0("XXXXXX_pyramids_", current_date, ".pdf"))
  grDevices::pdf(pdf_path, width = 5, height = 5.2)
  par(cex.main = 1.5, cex.lab = 0.5, cex.axis = 0.5, cex = 0.5)

  for (i in 0:3) {#地区の数-1にする！！！三ヶ日地区なら三ヶ日町（全体）と19大字で計20。そして0:3は0も含め0:19とする
    pyramids(
      Left = male_data[[i + 1]],
