---
title: "新都田地区 人口ピラミッドレポート（出力仕様準拠）"
output:
...
file_path <- "C:/Users/pirat/Documents/mikkabi_population_analysis/data/processed/shinmiyakoda_population_combined.xlsx"
output_dir <- "C:/Users/pirat/Documents/mikkabi_population_analysis/figures/pyramid/新都田地区"
...
roman_titles <- c("shinmiyakoda (Overall)","ityoume","nityoume","santyoume","yontyoume","gotyoume")
...
for (current_date in date_strings) {
  ...
  # PDF出力（あなたの設定に完全準拠）
  pdf_path <- file.path(output_dir, paste0("shinmiyakoda_pyramids_", current_date, ".pdf"))
