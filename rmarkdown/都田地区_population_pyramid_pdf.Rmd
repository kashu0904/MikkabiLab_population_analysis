...
file_path <- "C:/Users/pirat/Documents/mikkabi_population_analysis/data/processed/miyakoda_population_combined.xlsx"
output_dir <- "C:/Users/pirat/Documents/mikkabi_population_analysis/figures/pyramid/都田地区"
...
roman_titles <- c("miyakoda (Overall)","miykoda","takisawa","washizawa")
...
for (current_date in date_strings) {
  ...
  # PDF出力（あなたの設定に完全準拠）
  pdf_path <- file.path(output_dir, paste0("miyakoda_pyramids_", current_date, ".pdf"))
