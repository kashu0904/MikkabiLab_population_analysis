...
file_path <- "C:/Users/pirat/Documents/mikkabi_population_analysis/data/processed/nakaze_population_combined.xlsx"
output_dir <- "C:/Users/pirat/Documents/mikkabi_population_analysis/figures/pyramid/中瀬地区"
...
roman_titles <- c("nakaze (Overall)","kamijima","nakaze","toyoyasu",
                  "nakazeittyoume","nakazenityoume","nakazesantyoume")
...
for (current_date in date_strings) {
  ...
  # PDF出力（あなたの設定に完全準拠）
  pdf_path <- file.path(output_dir, paste0("nakaze_pyramids_", current_date, ".pdf"))
