...
file_path <- "C:/Users/pirat/Documents/mikkabi_population_analysis/data/processed/hamana_population_combined.xlsx"
output_dir <- "C:/Users/pirat/Documents/mikkabi_population_analysis/figures/pyramid/浜名地区"
...
roman_titles <- c("hamana (Overall)","komatsu","uchino",
                  "uchinodaiittyoume","uchinodainityoume","uchinodaisantyoume","uchinodaiyontyoume",
                  "hirakuchi",
                  "somechidaiittyoume","somechidainityoume","somechidaisantyoume",
                  "somechidaiyontyoume","somechidaigotyoume","somechidairokutyoume")
...
for (current_date in date_strings) {
  ...
  # PDF出力（あなたの設定に完全準拠）
  pdf_path <- file.path(output_dir, paste0("hamana_pyramids_", current_date, ".pdf"))
